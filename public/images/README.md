...
내일 수집용 ID/검색어 리스트는 `public/images/PHOTO_SHOTLIST.md` 참고.

## 1) 도시 카드 이미지
- 경로: `public/images/cities/<cityId>/cover.<확장자>`
- 현재 적용된 확장자: 대부분 `jpeg`, `budapest`는 `webp`
...
## 2) 장소 카드 썸네일 이미지
- 경로: `public/images/spots/<spotId>/thumb.<확장자>`
- 사용 화면: 메인 > 유명 장소 목데이터 리스트 카드
- 권장 비율/해상도: 1:1, 최소 800x800

## 3) 장소 상세 히어로 이미지
- 경로: `public/images/spots/<spotId>/hero.<확장자>`
